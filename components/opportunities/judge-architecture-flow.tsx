  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4 animate-in fade-in duration-700 relative pb-24">
      <div className="text-center mb-20">
        <div className="inline-flex items-center justify-center px-4 py-2 rounded-[999px] bg-warning/10 border border-warning/30 text-warning text-[11px] font-mono font-semibold uppercase tracking-widest mb-8 shadow-sm">
          USAII Global AI Hackathon
        </div>
        <h1 className="text-[56px] leading-[1.1] font-semibold tracking-[-0.03em] mb-6 text-foreground">ClearPath OS Architecture</h1>
        ...
        <div className="space-y-16">
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-center gap-8 group">
            <div className="md:w-1/2 flex justify-end text-right pr-14 hidden md:block">
              <h3 className="text-[20px] font-semibold mb-3 text-foreground">1. The Cognitive Barrier</h3>
            ...
            <div className="md:w-1/2 md:pl-14 text-center md:text-left">
              <h3 className="text-[20px] font-semibold mb-3 md:hidden text-foreground">1. The Cognitive Barrier</h3>
              <div className="liquid-glass-card p-5 inline-block text-left w-full max-w-[320px]">
                <div className="text-[11px] uppercase tracking-widest font-semibold text-muted-foreground mb-3">Input</div>
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-center gap-8 group">
            <div className="md:w-1/2 flex justify-end md:pr-14 text-center md:text-right order-3 md:order-1">
              <div className="liquid-glass-card p-5 border-primary/20 bg-primary/5 inline-block text-left md:text-right w-full max-w-[320px]">
                <div className="text-[11px] uppercase tracking-widest font-semibold text-primary mb-3">Processing Node</div>
            ...
            <div className="md:w-1/2 md:pl-14 text-center md:text-left order-2 md:order-3">
              <h3 className="text-[20px] font-semibold mb-3 text-foreground">2. Deterministic AI Extraction</h3>
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-center gap-8 group">
            <div className="md:w-1/2 flex justify-end text-right pr-14 hidden md:block">
              <h3 className="text-[20px] font-semibold mb-3 text-foreground">3. Mathematical Readiness Engine</h3>
            ...
            <div className="md:w-1/2 md:pl-14 text-center md:text-left">
              <h3 className="text-[20px] font-semibold mb-3 md:hidden text-foreground">3. Mathematical Readiness Engine</h3>
              <div className="liquid-glass-card p-5 border-success/20 bg-success/5 inline-block text-left w-full max-w-[320px]">
                <div className="text-[11px] uppercase tracking-widest font-semibold text-success mb-3">Frontend Logic</div>
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-center gap-8 group">
             <div className="md:w-1/2 flex justify-end md:pr-14 text-center md:text-right order-3 md:order-1">
              <div className="liquid-glass-card p-5 border-warning/20 bg-warning/5 inline-block text-left md:text-right w-full max-w-[320px]">
                <div className="text-[11px] uppercase tracking-widest font-semibold text-warning mb-3">Safety Checkpoint</div>
            ...
            <div className="md:w-1/2 md:pl-14 text-center md:text-left order-2 md:order-3">
              <h3 className="text-[20px] font-semibold mb-3 text-foreground">4. Missing Document Detection</h3>
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-center gap-8 group">
            <div className="md:w-1/2 flex justify-end text-right pr-14 hidden md:block">
              <h3 className="text-[20px] font-semibold mb-3 text-foreground">5. Sequenced Action Plan</h3>
            ...
            <div className="md:w-1/2 md:pl-14 text-center md:text-left">
              <h3 className="text-[20px] font-semibold mb-3 md:hidden text-foreground">5. Sequenced Action Plan</h3>
              <div className="liquid-glass-card p-5 inline-block text-left w-full max-w-[320px]">
                <div className="text-[11px] uppercase tracking-widest font-semibold text-foreground mb-3">Output UI</div>
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-center gap-8 group">
             <div className="md:w-1/2 flex justify-end md:pr-14 text-center md:text-right order-3 md:order-1">
              <div className="liquid-glass-card p-6 border-2 border-success bg-success/10 shadow-glass-card inline-block text-left md:text-right w-full max-w-[320px]">
                <div className="text-[11px] uppercase tracking-widest font-semibold text-success mb-3">Impact Delivered</div>
                <div className="font-mono text-[14px] font-semibold text-foreground leading-relaxed">Application Successfully Submitted</div>
              </div>
            </div>
            ...
            <div className="md:w-1/2 md:pl-14 text-center md:text-left order-2 md:order-3">
              <h3 className="text-[24px] font-semibold mb-3 text-success">6. Final Student Success</h3>
