...
export function AdvisorImmersionMode({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[200] font-sans flex flex-col items-center justify-between overflow-hidden bg-[#030712]/90" style={{ backdropFilter: 'blur(20px)' }}>
      
      {/* Background ambient */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none gpu-accelerate">
        <div className="absolute top-[-20%] left-[-10%] w-[50vw] h-[50vw] rounded-full bg-[#3D0E61]/12 animate-ambientPulse" style={{ filter: 'blur(100px)' }} />
        <div className="absolute bottom-[-20%] right-[-10%] w-[60vw] h-[60vw] rounded-full bg-[#858AE3]/6" style={{ filter: 'blur(120px)' }} />
      </div>
