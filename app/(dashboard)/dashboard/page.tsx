      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        <div className="liquid-glass-card p-6 border-l-2 border-l-warning hover:-translate-y-1 transition-spring cursor-default">
          <div className="flex items-center gap-2 text-muted-foreground mb-3">
            ...
            <span className="text-[11px] font-bold uppercase tracking-wider text-foreground/80">Critical</span>
          </div>
          <div className="text-[32px] leading-none font-bold text-foreground">2</div>
        ...
        <div className="liquid-glass-card p-6 border-l-2 border-l-danger hover:-translate-y-1 transition-spring cursor-default">
          <div className="flex items-center gap-2 text-muted-foreground mb-3">
            ...
            <span className="text-[11px] font-bold uppercase tracking-wider text-foreground/80">Urgent</span>
          </div>
          <div className="text-[32px] leading-none font-bold text-foreground">1</div>
        ...
        <div className="liquid-glass-card p-6 border-l-2 border-l-primary hover:-translate-y-1 transition-spring cursor-default">
          <div className="flex items-center gap-2 text-muted-foreground mb-3">
            ...
            <span className="text-[11px] font-bold uppercase tracking-wider text-foreground/80">Action</span>
          </div>
          <div className="text-[32px] leading-none font-bold text-foreground">8</div>
        ...
        <div className="liquid-glass-card p-6 border-l-2 border-l-success hover:-translate-y-1 transition-spring cursor-default">
          <div className="flex items-center gap-2 text-muted-foreground mb-3">
            ...
            <span className="text-[11px] font-bold uppercase tracking-wider text-foreground/80">Value</span>
          </div>
          <div className="text-[32px] leading-none font-bold text-success">₹50k</div>
          ...
          <DecisionCard title="System Status" className="liquid-glass-card bg-glass-surface">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="flex items-center gap-1.5 text-[11px] font-bold text-success bg-success/10 border border-success/20 px-2 py-0.5 rounded-[999px] uppercase tracking-wider">
